<%-- 
    Document   : EspinillerasGuard_3
    Created on : 10/05/2017, 04:47:41 PM
    Author     : User
--%>
...
<html>
    ...
    <body>         
   	<div id="menu">
      	 ...
      	 <img src="../../img/Imagenes/Futbol/EspinillerasGuard_3.png"/>
         <div class="DIV_info">
          <h1 class="H1_Titulo">
          Espinilleras nike
          </h1>
          ...
          <a href="../../Ventas.jsp"><button>Comprar</button></a>        
       </div>
       </div>
       </div>          
</body>
