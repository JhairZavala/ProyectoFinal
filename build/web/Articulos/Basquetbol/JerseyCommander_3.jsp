<%-- 
    Document   : JerseyCommander_3
    Created on : 10/05/2017, 01:56:26 PM
    Author     : USUARIO
--%>
    ...
    <body>         
   	<div id="menu">
            ...
            <div class="sep">
             ...
             <div class="DIV_main">
        	      <div class="DIV_imagenPrincipal">
      	 <img src="../../img/Imagenes/Basquetbol/JerseyCommander_3.png"/>
         <div class="DIV_info">
          <h1 class="H1_Titulo">
          Tirantes adidas
          </h1>
          A la venta ya en Allahu Akbar, compra rapido porque te los ganan
          </br>
          </br>
          Precio: 500$<br />
          </br>
          <a href="../../Ventas3.jsp"><button>Comprar</button></a> 
        </div>
      </div>
       </div>          
</body>
<div class="contacto">
         ...
         <br /><label>| Contactanos | Facebook: Allahu Akbar | Twitter: @AllahuAkbar |</label>
         </div>
