<%-- 
    Document   : GorraCowboys_3
    Created on : 10/05/2017, 05:41:21 PM
    Author     : User
--%>
...
<html>
    ...
    <body>         
   	<div id="menu">
      	 ...
      	 <img src="../../img/Imagenes/Americano/GorraCowboys_3.png"/>
         <div class="DIV_info">
          <h1 class="H1_Titulo">
          Gorra
          </h1>
          A la venta ya en Allahu Akbur, compra rapido porque te los ganan
          </br>
          <br />
          Precio: 400$<br />
          <br />
