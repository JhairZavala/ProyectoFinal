<%-- 
    Document   : JerseyDelphins_3
    Created on : 10/05/2017, 06:12:38 PM
    Author     : User
--%>
...
<html>
    ...
    <body>         
   	<div id="menu">
      	 ...
      	 <img src="../../img/Imagenes/Americano/JerseyDelphins_3.png"/>
         <div class="DIV_info">
          <h1 class="H1_Titulo">
          Playera de Americano
          </h1>
          ...
          Precio: 1100$<br />
          <br />
          <a href="../../Ventas2.jsp"><button>Comprar</button></a>        
       </div>
       </div>
       </div>          
</body>
